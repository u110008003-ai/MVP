      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
        ...
        <section className="glass-panel-strong grid gap-4 rounded-[2rem] p-6 md:grid-cols-3">
          <article className="glass-chip rounded-[1.25rem] p-4">
            <h2 className="text-base font-semibold text-[var(--color-text)]">先整理，再升格</h2>
          ...
          <article className="glass-chip rounded-[1.25rem] p-4">
            <h2 className="text-base font-semibold text-[var(--color-text)]">板塊式草稿</h2>
            <p className="muted-copy mt-2 text-sm">
          ...
          <article className="glass-chip rounded-[1.25rem] p-4">
            <h2 className="text-base font-semibold text-[var(--color-text)]">升格規則</h2>
            <p className="muted-copy mt-2 text-sm">
        ...
        <section className="grid gap-2">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-semibold text-[var(--color-text)]">目前所有草稿提案</h2>
          </div>
